...
class Tree(ttk.Treeview):
    def __init__(self,parent):
     ...
     #treeview dos pontos de coleta
        ...
        #definindo os titulos da colunas
    ...
    #treeview do iqar
        ...
        #definindo os titulos das colunas
...
###############
    ...
    def atualiza_treeview_ponto(self):
        if os.path.exists("Banco_Dados.db"):
            ...
            for row in rows:
                # para inserir novos itens, o "" identificador do pai, no caso e a raiz, "end" possição da inserção, value  o valor a ser inserido, no caso a linha da lista gerada pelo metodo no banco de dados
